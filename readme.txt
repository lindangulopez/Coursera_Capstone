...
Review criteria:
This Peer_Graded Capstone Project is worth 70% of the total grade and  was completed
in 2 weeks.

-------> -------> -------> -------> -------> -------> -------> -------> ------->
The IPython notebook contains code and is annotated to meet assignment's:
*** 'The Battle of Neighbourhoods' deliverables

The first part of the notebook, where data sourcing and preparation were done
has been commented out '#' to reduce the size of the notebook. The key outcomes
have been saved as, csv, html or png files and are on:
** http://nurturingnature.blogspot.com/2019/06/blog-post.html
** https://github.com/lindangulopez/Coursera_Capstone


They can be forked and/uploaded to be used for your own creations, so please do
fork and collaborate!!!
-------> -------> -------> -------> -------> -------> -------> -------> ------->

Python 3: Real Solutions with Real World Data
Tailor Made Liveability Index
...
in progress: Publish Report, 'Python 3: Real Solutions with Real World Data'
in progress: Publish Blog, 'Tailor Made Liveability Index'

-------> -------> -------> -------> -------> -------> -------> -------> ------->
Find the number and type of venues in each of the neighbourhoods, then merge the
resulting DataFrame with that of the Global Liveability Index Report's Features:
- Stability
- Health-care
...
Visualise Results, with leaf-maps and word-clouds;
-------> -------> -------> -------> -------> -------> -------> -------> ------->
...
IPython Notebook, Report and Blog Posted by: Linda Angulo Lopez

Contact information: mailto:angulo.linda@gmail.com
Copyright 2019, Linda Angulo Lopez, Environmental Consultant
